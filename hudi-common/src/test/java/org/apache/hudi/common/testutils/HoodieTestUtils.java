...
public class HoodieTestUtils {
  ...
  public static HoodieReplaceStat createReplaceStat(final String partitionPath, final String fileId1) {
    ...
    replaceStat.setNewFileIds(Collections.singletonList(fileId1 + "1"));
    return replaceStat;
  }
